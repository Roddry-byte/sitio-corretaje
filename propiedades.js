...
const PROPIEDADES = [
    {
        ...
        bodegas: 1,
        imagenes: ["./imagenes/casa1.jpeg", "./imagenes/casa22.jpg", "./imagenes/casa33.jpg"],
        descripcion: "Depto luminoso a pasos de Metro Los Leones. Living-comedor con salida a terraza, cocina equipada, dormitorio en suite + baño completo. Edificio moderno con conserjería 24/7.",
        detalles: ["Gastos comunes: $120.000", "Año: 2018", "Disponibilidad inmediata"],
        coords: [-33.4258, -70.6162]
    },
    {
        ...
        bodegas: 1,
        imagenes: ["./imagenes/casa22.jpg", "./imagenes/casa33.jpg", "./imagenes/casa1.jpeg"],
        descripcion: "Casa familiar remodelada, cocina integrada, quincho y patio orientado al norte. Cercana a colegios y áreas verdes.",
        detalles: ["Contribuciones al día", "Recepción final regularizada", "Orientación nor-oriente"],
        coords: [-33.4569, -70.5955]
    },
    {
        ...
        destacada: true,
        imagenes: ["./imagenes/casa33.jpg", "./imagenes/casa1.jpeg", "./imagenes/casa22.jpg"],
        descripcion: "Oficina equipada en eje Apoquindo, recepción, 1 privado + open space, kitchenette. Edificio con accesos controlados.",
        detalles: ["Gastos comunes aprox. $110.000", "Climatización", "Disponibilidad: inmediata"],
        coords: [-33.4166, -70.5920]
    },
    {
...
/**
 * Plantilla principal para tarjetas de propiedades en el listado - SIMPLIFICADA Y MÁS SOBRIA
 */
function cardTemplate(p) {
    const imgs = p.imagenes
        .map((src) => `<img src="${src}" alt="${p.titulo}" loading="lazy" />`)
...
// ============================
// FUNCIÓN PARA PROPIEDADES DESTACADAS
// ============================

/**
 * Obtiene las propiedades destacadas (las primeras 3-4 del array)
 * Puedes modificar esta lógica para seleccionar las que quieras destacar
 */
function getPropiedadesDestacadas(limite = 3) {

    // Opción 2: Filtrar por propiedades marcadas como destacadas
